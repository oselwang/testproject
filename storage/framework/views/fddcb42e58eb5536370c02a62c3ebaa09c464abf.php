    ...
    <div class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#navbarShareNEat">
                    <span class="icon-bar"></span>
                    <span class="icon-bar"></span>
                    <span class="icon-bar"></span>
                </button>
                <a href="#" class="navbar-brand">Share N Eat</a>
            </div>

            <div class="collapse navbar-collapse" id="navbarShareNEat">
                <ul class="nav navbar-nav">
                    <li class="active"><a href="#">Testing Menu 1</a></li>
                    <li><a href="#">Testing Menu 2</a></li>
                    <li><a href="#">Testing Menu 3</a></li>
                </ul>
...
<footer>
    <div class="navbar navbar-default navbar-fixed-bottom">
        <div class="container">
            <span class="navbar-text" style="float:right;">&copy; 2016 Share N Eat. All rights reserved.</span>
        </div>
    </div>
