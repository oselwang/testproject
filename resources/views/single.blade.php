...
<div class="single">
    <div class="container">
        <h1 class="animated fadeInLeftBig" data-wow-duration="1000ms" data-wow-delay="300ms">Nulla Quis lorum nisl
            tempus convallis quis ac lactus</h1>
        ...
        <p class="tortor wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">There are many variations of
        ...
        <div class="three-com">
            <h3 class="wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">3 Comment <span>on</span> <label>Donec
                    volutpat ligula non dapibus volutpat</label></h3>
