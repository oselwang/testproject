...
<html>
<head>
    <title>Cooks a Hotels and Restaurants Category Flat Bootstrap Responsive Website Template | Short Codes ::
        w3layouts</title>
...
<div class="typo">
    <div class="container">
        ...
        <p class="wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">For basic stylinglight padding and
            only horizontal add the base class <code>.table</code> to any <code>&lt;table&gt;</code>.</p>
        ...
        <p class="wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">Add any of the following classes to
            the <code>.table</code> base class.</p>
        <p class="wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">Adds zebra-striping to any table row
            within the <code>&lt;tbody&gt;</code> via the <code>:nth-child</code> CSS selector (not available in IE7-8).
        </p>
        <div class="bs-docs-example wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
        ...
        <p class="wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">Add borders and rounded corners to the
            table.</p>
        <div class="bs-docs-example wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
            <table class="table table-bordered">
                <thead>
        ...
        <p class="wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">Enable a hover state on table rows
